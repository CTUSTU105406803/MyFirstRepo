<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMlogin.aspx.cs" Inherits="CMlogin" %>
                ...
                <div class="row">
                    <div class="col-sm"></div>
                        ...
                        <div class="col-sm bg-dark text-center form-group ">
                            <br />                            
                        <img class="img-thumbnail" src="Images/ctu.png" />
                            <br />
                            <br />                            
                        <h2 class="font-weight-bold text-info">e化教室報修處理系統<br />__後台管理登入__</h2>                           
                            <br /> 
